...
def BayesianOptimization(config):
    ...
    bit_1=ChoiceParameter(name="bit_1", values=[2,3,4,6,7,8], parameter_type=ParameterType.INT,sort_values=True,is_ordered=True)
    bit_2=ChoiceParameter(name="bit_2", values=[2,3,4,6,7,8], parameter_type=ParameterType.INT,sort_values=True,is_ordered=True)
    bit_3=ChoiceParameter(name="bit_3", values=[2,3,4,6,7,8], parameter_type=ParameterType.INT,sort_values=True,is_ordered=True)

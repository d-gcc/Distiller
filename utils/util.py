...
def insert_SQL(model_name, pid, dataset, parameter, parameter_desc, type_q, bits, distillation, accuracy, metric_1, metric_1_desc, metric_2, metric_2_desc, metric_3, metric_3_desc, metric_4, metric_4_desc):
